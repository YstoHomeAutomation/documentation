...
% ---
\titulo{Ysto\\ Automação Residencial}
...
% Capitulos
% ---
\include{conteudo/01-apresentacao-geral-do-projeto}
\include{conteudo/02-definicao-do-problema}
\include{conteudo/03-objetivos}
\include{conteudo/04-analise-de-tecnologias-e-ferramentas}
\include{conteudo/05-descricao-da-solucao}
\include{conteudo/06-abordagem-de-desenvolvimento}
\include{conteudo/07-arquitetura-do-sistema}
\include{conteudo/08-funcionamento-do-sistema}
\include{conteudo/09-validacao}
\include{conteudo/10-consideracoes-finais}
